...
module.exports.$deadbeef_linkcolor = "#0090ff";
module.exports.$deadbeef_alinkcolor = "#0090ff";
module.exports.$deadbeef_vlinkcolor = "#0090ff";
module.exports.$deadbeef_textcolor = "#ffffff";
module.exports.$deadbeef_bgcolor = "#010101";
module.exports.$deadbeef_tonemap = [ [30,10,0], [40,40,0], [90,0,90], [10, 30, 30] ];
module.exports.$deadbeef_title = "deadbeef";
module.exports.gen_html = false;
module.exports.elt = "font"; // div, span, font, etc...
...
// porting from php, kept this one php method
...
module.exports.substr_replace = substr_replace;
...
function genbyte( $tm_colors )
{
  ...
  let glyph = `<${module.exports.elt} color=\"#` + str_pad( dechex( $rgb[0] ), 2, "00", "STR_PAD_LEFT" ) 
...
module.exports.genbyte = genbyte;
...
function gennibble( $tm_colors )
{
  ...
  let $rgb = tonemap( $tm_colors, $value / 255.0 );
  return `<${module.exports.elt} color=\"#` + str_pad( dechex( $rgb[0] ), 2, "00", "STR_PAD_LEFT" ) 
                        + str_pad( dechex( $rgb[1] ), 2, "00", "STR_PAD_LEFT" )
                        + str_pad( dechex( $rgb[2] ), 2, "00", "STR_PAD_LEFT" )
                        + "\">" + str_pad( dechex( $value ), 1, "0", "STR_PAD_LEFT" ) 
                        + `</${module.exports.elt}>`;
}
module.exports.gennibble = gennibble;
...
module.exports.getHtmlVisibleStrLen = getHtmlVisibleStrLen;
...
module.exports.detectOffsetOverride = detectOffsetOverride;
...
function chunk( text ) {
   return chunkArray( text.split('') ).map( r => r.join('') ).map( r => `<${module.exports.elt} color="${module.exports.$deadbeef_textcolor}">${r}</${module.exports.elt}>` ).join('');
}
...
function DrawPage( $text, $textoffset, $cols, $rows )
{
   let str = '';
   if (module.exports.gen_html) {
    str += `<html><head>
      <title>${module.exports.$deadbeef_title}</title>   
      </head>
      <body bgcolor=\"${module.exports.$deadbeef_bgcolor}\" text=\"${module.exports.$deadbeef_textcolor}\" link=\"${module.exports.$deadbeef_linkcolor}\" alink=\"${module.exports.$deadbeef_alinkcolor}\" vlink=\"${module.exports.$deadbeef_vlinkcolor}\">
   ...
   let $size_of_glyph = genbyte( module.exports.$deadbeef_tonemap ).length; // size of one hex byte thingie
   let $size_of_nibble_glyph = gennibble( module.exports.$deadbeef_tonemap ).length; // size of one hex byte thingie
   let $in_text = false;
   let $page = "";
   for (let $x = 0; $x < $rows; $x += 1)
   {
      ...
      if ($detectedoffset % 2)// odd
      {
         ...
         $text2write = gennibble( module.exports.$deadbeef_tonemap ) + $text2write;
         $detectedoffset -= 1;
      }
      ...
      if ($text2write_len % 2)// odd
      {
        ...
        $text2write += gennibble( module.exports.$deadbeef_tonemap );
        }
      let $line_original = genline( module.exports.$deadbeef_tonemap, $cols, $x, $rows );
